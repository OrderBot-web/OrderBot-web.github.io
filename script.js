...
if (token) {
  ...
  fetch("https://discord.com/api/users/@me/guilds", { headers: { Authorization: `Bearer ${token}` } })
    ...
    .then(guilds => {
      ...
      if (!isMember) {
        alert("Devi entrare nel nostro server Discord prima di ordinare!");
...
document.getElementById("configBot").addEventListener("click", () => {
  document.getElementById("botFormTitle").innerText = "Configura Bot";
  document.getElementById("budgetField").placeholder = "Inserisci Budget";
  document.getElementById("formScreen").style.display = "block";
});

document.getElementById("hostBot").addEventListener("click", () => {
  document.getElementById("botFormTitle").innerText = "Host Bot H24";
  document.getElementById("budgetField").placeholder = "Inserisci Budget";
  document.getElementById("formScreen").style.display = "block";
});
